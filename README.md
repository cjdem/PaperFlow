...
5. **文件操作** → 下载 PDF、预览 PDF、重新分析
6. **批量操作** → 多选模式下批量删除、分组、导出
7. **团队协作** → 创建团队空间、邀请成员、共享论文
8. **系统配置** → 管理员面板配置 LLM 策略、查看存储统计
...
### 存储结构
```
uploads/papers/user_{id}/{md5_hash}.pdf
```
